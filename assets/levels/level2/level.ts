                ...
                const levelData = parseLevelData(json),
                    s = (p5: import("p5")) => {
                        ...
                        p5.setup = function () {
                            ...
                            const keys = Array.from(gamespace.guns.keys()),
                                randomWeapon = () => new gun(gamespace.guns.get(Array.from(gamespace.guns.keys())[Math.floor(Math.random() * gamespace.guns.size)]) as gunPrototype),
                                //@ts-ignore
                            ...
                            },
                                {
                                    ...
                                    update() {
                                        const e = $("deathmatch-countdown") as HTMLDivElement,
                                            d = 300000 - (gamespace.currentUpdate - gamespace.created),
