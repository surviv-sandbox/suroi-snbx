 ...
 */
var srvsdbx_Animation;
(function (srvsdbx_Animation) {
    /**
     ...
     */
    function addBindings(fn) {
        fn.default = fn.bind(srvsdbx_Animation.easingFunctions, 0, 1);
        fn.bindToBounds = (a, b) => fn.bind(srvsdbx_Animation.easingFunctions, a, b);
        return fn;
    }
    /**
     ...
     */
    srvsdbx_Animation.easingFunctions = {
        /**
         ...
         */
        linterp: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         */
        easeInSine: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutSine: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutSine: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInCubic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutCubic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutCubic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInQuintic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutQuintic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (1 - (1 - t) ** 3);
         ...
         * @param t The interpolation factor
         */
        easeInOutQuintic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInCirc: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutCirc: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutCirc: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInElastic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutElastic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutElastic: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (t < 0.5
         ...
         * @param t The interpolation factor
         */
        easeInQuad: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutQuad: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutQuad: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (t < 0.5
         ...
         * @param t The interpolation factor
         */
        easeInQuart: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutQuart: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutQuart: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (t < 0.5
         ...
         * @param t The interpolation factor
         */
        easeInExpo: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutExpo: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutExpo: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (t < 0.5
         ...
         * @param t The interpolation factor
         */
        easeInBack: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeOutBack: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
         ...
         * @param t The interpolation factor
         */
        easeInOutBack: addBindings(function (a, b, t) {
            switch (t) {
                case 0: return a;
                case 1: return b;
                default: return a + (b - a) * (t < 0.5
        ...
        cubicBezier(p1x, p1y, p2x, p2y) {
            ...
            const p1 = new srvsdbx_Geometry.Vector2D(p1x, p1y), p2 = new srvsdbx_Geometry.Vector2D(p2x, p2y);
            return addBindings(function (a, b, t) {
                switch (t) {
                    case 0: return a;
                    case 1: return b;
        ...
        bezier(...points) {
            switch (points.length) {
                ...
                default: {
                    const invalidPoints = points.map((p, i) => [p, i]).filter(([p]) => !srvsdbx_Math.checkBounds(p.x, 0, 1));
                    if (invalidPoints.length)
                        throw new RangeError(`Invalid control points for bézier curve; all control points must have x components within [0, 1], but the following points did not:\n  ${invalidPoints.map(([p, i]) => `${srvsdbx_Geometry.Vector2D.prototype.toString.call(p)} (index: ${i})`).join("\n  ")}`);
                    ...
                    return addBindings(function (a, b, t) {
                        switch (t) {
                            ...
                            default: return controlPoints.reduce((acc, point, index) => acc.plus(point.scale(Number(coefficients[++index]) * (1 - t) ** (controlPoints.length - (index)) * t ** (index)), true), 
                            //                                                              ^^ see the comment about omitting (0, 0)
                            srvsdbx_Geometry.Vector2D.zeroVec()).y;
                        }
                        ;
                    });
                }
    ...
    class Animation {
         ...
         */
        static createIndeterminateAnimation(animationSkeleton) {
         ...
         */
        constructor(animationSkeleton, interpolationFunction) {
            this.#animationSkeleton = { ...animationSkeleton };
            this.#interpolationFunction = interpolationFunction;
            const keyframes = animationSkeleton.keyframes, fractions = keyframes.filter(k => k.fraction !== void 0).length;
            if (fractions && fractions != keyframes.length)
                throw new Error("Cannot mix fractional keyframes with other types; an animation must either be entirely composed of fractional keyframes or have none.");
            ...
            this.#duration = this.#animationSkeleton.duration = fractions
                ...
                : keyframes.reduce((acc, k) => k.delay !== void 0 ? acc + k.delay : Math.max(acc, k.time), 0);
    ...
    srvsdbx_Animation.Animation = Animation;
    /**
    ...
    class AnimationManager {
         ...
         */
        start(name) {
            const baseAnimation = extractValue(this.#animations[name]), T = this;
            let animation = this.#resolveKeyframes(baseAnimation), iteration = 0;
            /**
             * Determines the state of the animated object at a specified time
             * @param time A time at which to evaluate the animation, in ms. `1` is 1ms after the animation's start, not the animation's end
             * @param overflowReturnsLastFrame Whether or not to return the last keyframe if a time beyond the animation's duration is passed
             * @returns The state of the animated object at the specified time, or `null` if the time is beyond the animation's duration
             */
            function evaluate(time, overflowReturnsLastFrame) {
                const keyframes = animation.animationSkeleton.keyframes, l = keyframes.length, last = keyframes.at(-1);
                // Modify the time value based on repetition
                const repetition = animation.animationSkeleton.repetition, iterationLength = animation.duration + repetition?.delay;
                if (repetition && // repetition is enabled
                ...
                if (time >= animation.duration)
                    return overflowReturnsLastFrame ? last?.data : srvsdbx_ErrorHandling.Nothing;
                for (let i = 0; i < l; i++) {
                    const current = {
                    ...
                    if (current.time > time) {
                        ...
                        return i || iteration != 0 ?
                            animation.interpolationFunction(prev.data, current.data, (current.easing ??= srvsdbx_ErrorHandling.identity)((time - prev.time) / (current.time - prev.time)))
                            : current.data;
                    }
                }
                return overflowReturnsLastFrame ? last?.data : srvsdbx_ErrorHandling.Nothing;
    ...
    srvsdbx_Animation.AnimationManager = AnimationManager;
})(srvsdbx_Animation || (srvsdbx_Animation = {}));
