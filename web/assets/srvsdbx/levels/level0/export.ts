declare const Matter: typeof import("../../../../types/matter/index");
declare const p5: typeof import("../../../../types/p5/index");
            ...
            p5 => {
                p5.setup = () => {
                    ...
                    function generateBot(pos?: { x: number, y: number; }) {
                        ...
                        // bot.inventory.setItem(2, "Main", new Melee(bot, gamespace.prototypes.melees.get(`srvsdbx::Lasr Swrd (${pickRandomInArray(["Green", "Blue", "Red"])})`)!));
                    ...
                    // player.inventory.setItem(0, "Main", new Gun(player, gamespace.prototypes.firearms.get("srvsdbx::Bugle")!));
                    player.inventory.setItem(1, "Main", new Gun(player, randomGun()));
                    // player.inventory.setItem(1, "Main", new Gun(player, gamespace.prototypes.firearms.get("srvsdbx::Scout Elite")!));
                    player.inventory.setItem(2, "Main", new Melee(player, randomMelee()));
                    // player.inventory.setItem(2, "Main", new Melee(player, gamespace.prototypes.melees.get(`srvsdbx::Lasr Swrd (${pickRandomInArray(["Green", "Blue", "Red"])})`)!));
