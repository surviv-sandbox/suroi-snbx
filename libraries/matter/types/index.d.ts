...
declare namespace Matter {
    ...
    */
    export class Bodies {
        ...
        * @return {body}
        */
        static fromVertices(x: number, y: number, vertexSets: Array<Vector> | Array<Array<Vector>>, options?: IBodyDefinition, flagInternal?: boolean, removeCollinear?: number, minimumArea?: number, removeDuplicatePoints?: number): Body;
    }
