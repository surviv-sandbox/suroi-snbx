export function makeSettings() {
    const doc = new DocumentFragment(), back = makeElement("button", "back", "surviv-blue-button"), menu = $("menu-container"), sidebar = makeElement("div", "settings-sidebar"), title = makeElement("div", "settings-title"), header = makeElement("div", "settings-header"), body = makeElement("div", "settings-body");
